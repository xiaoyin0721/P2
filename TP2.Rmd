...
\end{aligned}
$$
Her hvor der tjekkes der igen om $\mu$ er ligmed $\mu_0$, hvis ikke så forkastes $H_0$ og $H_a$ accepteres. Dette vil så betyde $\mu$ har en effekt på populations parameter. Der laves så en hypotesetest for at finde ud af hvilken af disse hypoteser skal beholdes.
...
Der findes så værdier som kan benyttes til at vurdere hvorvidt man beholder $H_0$ eller forkaster den. Disse vil forklares og arbejdes videre med i hypotesetest afsnittet. 
