...
Målet ved en lineær kongruens generator er at genere et tilfældigt tal mellem $0$ og $1$. Linear congruential generator er en PRNG, så tallene der fås fra generatoren, vil ikke være fuldstændigt tilfældige. 
Der er 4 vigtige værdier indenfor en lineær kongruens generator.:  
	$X_0$, som svarer til denne generators seed; $X_0$ $\leq$ 0.  
	$a$, som bliver ganget på $X_0$; $a$ $\leq$ 0.  
	$c$, som bliver adderet til $X_0$; $c$ $\leq$ 0.  
