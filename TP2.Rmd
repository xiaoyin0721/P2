...
- Hvordan, proportion/mean
  ...
  $$\begin{aligned}
  t = \frac{\overline{y}-\mu_0}{se} \ \ \ \ \ ,\ se=\frac{a}{\sqrt{n}}, \ \ \ df = n-1 
  \end{aligned}
  $$
Det kan ses at t-scoren afhænger af y-gennemsnit, og den estimerede $\mu_0$ værdi
```{r}
qdist("t", p = c(0.025,0.975), df = 2)
```

  
  - For kategoriske variabler, denoterer man middelværdien $\pi$
