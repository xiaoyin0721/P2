...
- Billede: 
En standardnormalfordeling er kendetegnet ved at $$\mu=0$$, og at $$\sigma = 1$$,Plottet af standardnormalfordelingen vises nedenunder.
```{r}
qdist("norm",p=1,mean = 0, sd = 1,xlim = c(-4,4))
qdist("norm",p=0.5,mean = 0, sd = 1,xlim = c(-4,4))
```
...
### Uniform fordeling
En uniform fordeling, er hvor dataet bliver indelt i lige store intervaller, og alle intervaller, har lige antal observationer.
