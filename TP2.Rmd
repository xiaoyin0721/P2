...
gf_histogram(~linear_congruence(i=1000, X_0 = 1576), breaks = seq(0, 1, by=0.1), fill="black", col="grey", xlim = c(0, 1), ylab = "Antal", xlab = "Tilfældige tal inddelt i intervaller",title = "Resultaterne af den implementerede PRNG")
...
exp <-  10000/20
X_squared <- sum((obs-exp)^2)/exp
X_significance <- qchisq(0.95, 19, ncp = 0, lower.tail = TRUE)
X_squared 
X_significance
...
=======
>>>>>>> 7d23cb340fbd4700bd4128a0e0274cd739c04e52
