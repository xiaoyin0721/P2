...
X_signifinance <- qchisq(0.95, 19, ncp = 0, lower.tail = TRUE)

```

It is observed that the observed difference is less than chi-squared value, therefore the LCG generated values follows a uniform distribution with 95% confidence. 


#Spektral test

Furthermore, the test result will be visualized by a spectral test.
...
plot(X[-1],X[-m],col="blue",type="p",pch="x",lwd=2)
}
...
The normal distribution cdf is $F_X(x) = $
